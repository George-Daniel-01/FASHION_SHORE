...
<li>
  <Link to="#" className="hover:text-gray-600 transition-colors">
    ...
    Men's Botton Wear</Link>
</li>
<li>
  <Link to="#" className="hover:text-gray-600 transition-colors">
    
   Women's Botton Wear</Link>
</li>
  </ul>
</div>
...
{/* Follow  Us*/}
<div>
  <h3 className="text-lg text-gray-800 mb-4">Follow</h3>
...
target="_blank"
 rel="noopener noreferrer" 
 className="hover:te">
  <RiTwitterFill className="h-5 w-4" />
 </a>
  </div>
...
{/* fOOT Botom */}
<div className="container mask-x-to-amber-50 mt-12 px-4 lg:px-0 border-t border-gray-200 pt-6">
  <p className="text-gray-500 text-sm tracking-tighter  text-center">
   © 2025,  CompileTab, All  Right Resersed
