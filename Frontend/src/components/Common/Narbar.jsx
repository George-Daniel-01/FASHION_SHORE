    ...
    <>
      ...
      <nav className="container mx-auto flex flex-wrap items-center justify-between py-4 px-4 md:px-6">
        ...
        <div className="mb-2 md:mb-0">
          <Link
            to="/collections/all"
            className="group relative inline-block text-lg md:text-2xl font-medium uppercase px-6 md:px-10 py-3 md:py-4 rounded-full text-black bg-white transition-all duration-200 hover:-translate-y-1 hover:shadow-[0_10px_20px_rgba(0,0,0,0.2)] active:translate-y-0.5 active:shadow-[0_5px_10px_rgba(0,0,0,0.2)] overflow-hidden"
          >
            <span className="absolute inset-0 rounded-full bg-white transition-all duration-500 scale-100 opacity-100 group-hover:scale-150 group-hover:opacity-0"></span>
