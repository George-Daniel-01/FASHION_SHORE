...
import productImg2 from "../../assets/womens-collection.webp";
...
const similarProducts = [
  ...
  // ✅ Set default main image once on mount
  useEffect(() => {
            ...
            <div className="mb-6">
              ...
              <div className="flex items-center space-x-4 mt-2">
                <button
                  ...
                  className="px-2 py-1 rounded text-lg border"
                >
                  -
                </button>
                <span>{quantity}</span>
  ...
  className={`bg-black text-white py-2 px-6 rounded w-full mb-3 mt-2 
...
>
  {isButtonDisabled ? "ADDING..." : "ADD TO CART"}
   ...
   <ProductsGrids products={similarProducts}/>
        </div>
      </div>
    </div>
  );
